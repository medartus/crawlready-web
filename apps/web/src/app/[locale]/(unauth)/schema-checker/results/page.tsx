  ...
  return (
    <>
      ...
      <Section className="border-b border-gray-200 bg-white py-12 dark:border-gray-700 dark:bg-gray-900">
        <div className="mx-auto max-w-5xl">
          <div className="rounded-3xl border-2 border-gray-200 bg-gradient-to-br from-white to-gray-50 p-8 shadow-xl md:p-12 dark:border-gray-700 dark:from-gray-800 dark:to-gray-800/50">
      ...
      <Section className="bg-gradient-to-br from-gray-50 to-white px-4 py-16 sm:px-6 lg:px-8 dark:from-gray-900 dark:to-gray-800">
        <div className="mx-auto max-w-5xl">

        ...
        <div className="mx-auto max-w-6xl">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="relative rounded-2xl border-2 border-gray-200 bg-white p-8 transition-all hover:border-indigo-300 hover:shadow-xl dark:border-gray-800 dark:bg-gray-900">
              ...
              <a
                href="#early-access"
                className={`${buttonVariants({ variant: 'outline', size: 'lg' })} group w-full`}
              >
                Get Started
            ...
            <div className="relative scale-105 rounded-2xl border-2 border-indigo-500 bg-gradient-to-b from-indigo-50 to-purple-50 p-8 shadow-2xl dark:from-indigo-950/50 dark:to-purple-950/50">
              ...
              <a
                href="#early-access"
                className={`${buttonVariants({ size: 'lg' })} group w-full bg-gradient-to-r from-indigo-600 to-purple-600 shadow-xl hover:shadow-2xl`}
              >
                Start Free Trial
                <ArrowRight className="ml-2 size-4 transition-transform group-hover:translate-x-1" />
              </a>
          ...
          <div className="mt-12 space-y-4 text-center">
            <p className="text-gray-600 dark:text-gray-400">
              💎
              {' '}
              <span className="font-semibold text-gray-900 dark:text-white">Lifetime 50% discount</span>
              {' '}
              for first 100 users •
              🚀
              {' '}
              <span className="font-semibold text-gray-900 dark:text-white">No credit card required</span>
              {' '}
              to join •
              ⚡
              {' '}
            ...
            <p className="text-sm text-gray-500 dark:text-gray-500">
              📊
              {' '}
              <span className="font-semibold">Transparent overage pricing:</span>
              {' '}
              $0.50 per 1,000 additional renders (46% cheaper than competitors) •
              🔔
              {' '}
              <span className="font-semibold">Proactive alerts:</span>
              {' '}

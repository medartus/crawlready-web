          ...
          <Accordion type="multiple" className="w-full">
            <AccordionItem value="item-1">
              ...
              <AccordionContent className="text-gray-600 dark:text-gray-400">
                ...
                We offer
                {' '}
                <strong>AI citation tracking</strong>
                {' '}
                (see when ChatGPT cites you),
                {' '}
                <strong>LLM-optimized schema injection</strong>
                ,
                and
                {' '}
                <strong>real-time AI crawler analytics</strong>
                —features Prerender doesn't have. Plus, we're
                {' '}
                <strong>46% cheaper</strong>
                {' '}
                on entry tiers ($49 vs $90) with better performance (&lt;200ms vs 300ms+).
              </AccordionContent>
            </AccordionItem>
            ...
            <AccordionItem value="item-5">
              ...
              <AccordionContent className="text-gray-600 dark:text-gray-400">
                ...
                {' '}
                (locked in forever), priority feature requests,
